...
import { installProjectInstanceDatasetCache } from "./project_instance_dataset_cache.js?v=20260909a";
...
export async function bootProjectInstance() {
  ...
  installProjectInstanceDependencyGraph(ctx);
